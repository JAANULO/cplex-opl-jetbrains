...
public class OplIncludeDeclarationImpl extends ASTWrapperPsiElement implements OplIncludeDeclaration {

  public OplIncludeDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
