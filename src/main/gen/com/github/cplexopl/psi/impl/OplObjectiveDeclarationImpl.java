...
public class OplObjectiveDeclarationImpl extends ASTWrapperPsiElement implements OplObjectiveDeclaration {

  public OplObjectiveDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OplVisitor visitor) {
    visitor.visitObjectiveDeclaration(this);
  }
