...
public class OplTupleFieldImpl extends ASTWrapperPsiElement implements OplTupleField {

  public OplTupleFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OplVisitor visitor) {
    visitor.visitTupleField(this);
  }
