...
public class OplTermImpl extends ASTWrapperPsiElement implements OplTerm {

  public OplTermImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<OplFactor> getFactorList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OplFactor.class);
  }
